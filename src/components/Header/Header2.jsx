...
export default function Header2() {
  ...
  return (
    <div className=" p-[3%] w-full h-full">
         <div className={`w-full header  h-[450px] bg-black bg-cover bg-center  rounded-[20px] flex flex-row font-bold py-[23px] mb-[10px] px-[25px]`} style={{ backgroundImage: `url(${assets.crousel2})` }}   >
